<nav id="sidebar">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($subject_list = mysqli_fetch_assoc($result)) {
                ...
                <ul class="collapse list-unstyled" id="<?php echo "{$subject_list["id"]}";?>">
                    <li>
                        <a href="index.php?subject=<?php echo urlencode($subject_list["id"]);?>">
                            About</a>
                    </li>
                    <?php //get all the pages
                    $result_pages = find_pages_for_subject($subject_list["id"],true);
                    ...
                    if (mysqli_num_rows($result_pages) > 0) {
                        ...
                        while ($page_list = mysqli_fetch_assoc($result_pages)) {
                            ?>
                            <li>
                                <a href="index.php?page=<?php echo urlencode($page_list["id"])."&subject=".urlencode($subject_list["id"]);?>">
    ...
    <ul class="list-unstyled CTAs">
        <li><a href="admin.php" class="download">Admin Page</a></li>
    </ul>
