			...
			<div class="row">
				<div class="content col-md-8 col-sm-12 col-xs-12">
					<div class="section-block">
						<div class="funding-meta">
							...
							<span class="type-meta"><i class="fa fa-tag"></i><a href="#"><?php echo $project['project_category'];?></a></span>
							<span class="type-meta"><i class="fa fa-globe"></i><a href="#"><?php echo $project['project_website'];?></a></span>
							<div><img src="<?php echo 'UploadsImages/'.$project['project_image'];?>" class="img-rounded img-responsive" alt="<?php echo $project['project_title'];?>"></div>
							<p><?php echo $project['project_short_description'];?></p>

							<?php if($bool=="funds"){ ?>
							<h2>&#x20B9; <?php echo $project["project_funds_received"];?> </h2>
							...
							<span class="goal-progress"><strong><?php echo $progress[0];?> %</strong> of <?php echo $project['project_people'];?> hired</span>
							<?php }
							...
							<span class="goal-progress"><strong><?php echo $progress[1];?> %</strong> of <?php echo $project['project_people'];?> hired</span>
						...
						<?php
						$date=$project['project_timestamp'];
						$date=substr($date,0,10);
						$date=date('Y-m-d', strtotime($date.'+ '.$project["project_deadline"].' days'));
						$today=date("Y-m-d");
					...
					<div class="section-block" align="center">
						<div class="btn-group" role="group">
							...
							<div class="col-sm-6"><p style="margin: 5px">LIKES: <strong id="like_count"><?php echo $project['project_likes']?></strong></p></div>

							<div class="col-sm-6"><p style="margin: 5px"> REPORTS: <strong id="report_count"><?php echo $project['project_reports']?></strong></p></div>
					</div>
					<!--tabs-->
					<div class="section-block">
				...
				<div class="content col-md-4 col-sm-12 col-xs-12">
					<div class="section-block summary">
						<h1 class="section-title"><?php echo $project['project_title'];?></h1>
						<div class="profile-contents">
							<h2 class="position"><?php echo $project['project_short_description'];?></h2>
							<img src="<?php echo 'UploadsImages/'.$project['project_image'];?>" class="img-rounded img-responsive" alt="<?php echo $project['project_title'];?>">
							<!--social links-->
							...
							<div><p style="margin: 5px"><strong> SHARES: </strong><?php echo $project['project_shares']?></p></div>
						</div>
					</div>
					<div class="section-block">
...
var liked=true;
var like_cnt=<?php echo $project['project_likes']?>;
...
var reported=true;
var report_cnt=<?php echo $project['project_reports']?>;
