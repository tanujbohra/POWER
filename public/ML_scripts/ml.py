...
project_short_description=sys.argv[3]
project_description=sys.argv[4]
project_image=sys.argv[5]
project_category=sys.argv[6]
project_location=sys.argv[7]
project_website=sys.argv[8]
project_funds=sys.argv[9]
project_people=sys.argv[10]
project_deadline=sys.argv[11]
project_photo=sys.argv[12]
...
try:
    ...
    #     # Read a all records
        ...
        sql = "insert into `project`(user_id,project_title,project_short_description,project_description,project_image,project_category,project_location,project_website,project_funds,project_people,project_deadline,project_photo,project_score) VALUES (user_id,project_title,project_short_description,project_description,project_image,project_category,project_location,project_website,project_funds,project_people,project_deadline,project_photo,project_score)"
        cursor.execute(sql)
        connection.commit()
