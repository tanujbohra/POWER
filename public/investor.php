...
?>
    ...
    <div class="row" style="max-height:900px;overflow:auto;">
                ...
                $query  = "SELECT sum(d.donation_amount) as amt,i.image,i.individual_name
                FROM donor as d 
                ...
                $query .= " group by i.image,i.individual_name";
                $query .= ";";
                        ...
                        <div class="col-md-4" style="height:450px;">
                            <div class="about-col border rounded">
                                ...
                                <div class="pl-3 pr-3 mb-1 text-right" style="height:110px;">
                                    ...
                                    <!-- Donation Amount-->
                                    <div class="mt-2 text-left">&#x20B9; <?php echo htmlentities($row1["amt"]);?>
                                      &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;   
...
<?php
                ...
                $query  = "SELECT sum(d.donation_amount) as amt,o.image,o.org_name
                FROM donor as d 
                ...
                $query .= " group by o.image,o.org_name";
                $query .= ";";
                $result = mysqli_query($conn,$query);
                confirm_query($result);
