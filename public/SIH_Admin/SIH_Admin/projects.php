    ...
    <div class="page-content">
        ...
        <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current" ><a href="projects.php"><i class="glyphicon glyphicon-book"></i> New Projects</a></li>
...
// " width="100" height="50" /></a>&nbsp;';
                     ...
                     ?>
                     <form action="project_accept.php" method="post">
                     ...
                     <form action="project_reject.php" method="post">
