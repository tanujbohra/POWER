...
$query3 = "SELECT u.status,u.user_id,u.email,u.type,i.individual_name,i.aadhaar_number,i.mobile_number from user u , individual i where u.user_id=i.user_id and u.status=0";
