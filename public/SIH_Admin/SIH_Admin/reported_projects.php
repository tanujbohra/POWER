    ...
    <div class="page-content">
        ...
        <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current" ><a href="reported_projects.php"><i class="glyphicon glyphicon-ban-circle"></i>Reported Projects</a></li>
		  ...
		  <div class="col-md-10">
  			...
  			<div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title">Reported Projects</div>
				</div>
              ...
              while($result = mysqli_fetch_assoc($project)){
                if($result['project_reports']>="3" || $result['project_score']>=20){
                  if($result['project_status']!=2){
                      echo "<tr class="."odd gradeX".">";
                      echo "<td>".$result['project_score']."</td>";
                      ?>
                      <?php
                      echo '<td><a href="11-alcohol.jpg" data-lightbox="image-1" data-title="'.$result["project_title"].'"><img src="11-alcohol.jpg"
" width="100" height="50" /></a>&nbsp;';
                     ...
                     ?>
                     <form action="project_reported_accept.php" method="post">
                     ...
                     <form action="project_reported_reject.php" method="post">
                     <input type="submit" value = "Block" style="float:right"  class="btn btn-default btn-danger">
