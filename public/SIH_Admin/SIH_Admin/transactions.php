    ...
    <div class="page-content">
        ...
        <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                  ...
                  <li  class="current" ><a href="transactions.php"><i class="glyphicon glyphicon-credit-card"></i>New Transactions</a></li>
                  <li><a href="all_transactions.php"><i class="glyphicon glyphicon-credit-card"></i>All Transactions</a></li>
		  ...
		  <div class="col-md-10">
  			...
  			<div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title">New Transactions</div>
				</div>
              ...
              while($result = mysqli_fetch_assoc($user1)){
                if($result['transaction_status']=="0"){
                  ...
                  echo "<td>".$result['transaction_amount']."</td>";
                     ...
                     <form action="transaction_reject.php" method="post">
